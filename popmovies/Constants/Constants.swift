...
struct Constants {
    ...
    struct IMAGES {
        static let ICON_APP                             = "IconApp"
        static let ICON_BACK                            = "BackIcon"
        static let ICON_CALENDAR                        = "CalendarIcon"
        static let ICON_CLOSE                           = "Close"
        static let ICON_HOME                            = "HomeIcon"
        static let ICON_GENRE                           = "GenreIcon"
        static let ICON_IMAGE_GRID                      = "ImageGridIcon"
        static let ICON_MOVIE_PROJECTOR                 = "MovieProjectorIcon"
        ...
        static let ICON_FACEBOOK                        = "FacebookIcon-white"
        static let ICON_TWITTER                         = "TwitterIcon-white"
        static let ICON_INSTAGRAM                       = "InstagramIcon-white"
