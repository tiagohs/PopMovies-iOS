...
class ImageViewerController: BaseViewController {
    static let ImageViewerControllerIdentifier      = "ImageViewerControllerIdentifier"
...
// MARK:  Creators and Prepares Methods

extension ImageViewerController {
    
    static func prepareImageViewerControllerFromPerson(from: UIViewController, person: Person?, image: Image, allImages: [Image], indexPath: IndexPath) {
        guard let controller = from.storyboard!.instantiateViewController(withIdentifier: ImageViewerControllerIdentifier) as? ImageViewerController else {
            return
        }
    ...
    static func prepareImageViewerControllerFromPerson(from: UIViewController, movie: Movie?, image: Image, allImages: [Image], indexPath: IndexPath) {
        guard let controller = from.storyboard!.instantiateViewController(withIdentifier: ImageViewerControllerIdentifier) as? ImageViewerController else {
            return
        }
